...
> 以下截图均已做脱敏处理，仅用于展示界面与功能结构，不包含真实客户、项目、版本、备注和文档信息。

### 当前半月

![当前半月](docs/images/current-half.png)

当前半月页面提供周期切换、新增任务、继承上期未完成、Excel 导出，以及重点工作 / 日常工作的分区列表。

### 历史记录

![历史记录](docs/images/documents.png)

支持跨半月期查询、月度趋势查看以及历史工作筛选。

### 已完成汇总

![已完成汇总](docs/images/history.png)

支持按期数、关键字和完成状态聚合查看历史已完成事项。

### 文档库

![文档库](docs/images/completed.png)

支持项目资料和常用文档的上传、分类、备注、打开与下载。
